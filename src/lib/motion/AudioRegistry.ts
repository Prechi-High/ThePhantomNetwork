...
export const AUDIO_CUE_REGISTRY: Record<string, AudioCueDef> = {
  ...
  reveal_burst: cue("reveal_burst", "/audio/wheel/reveal-burst.mp3", "rewards", "reward", 0.8),
  ...
  outcome_void: cue("outcome_void", "/audio/wheel/outcome-void.mp3", "rewards", "reward", 0.6),
  tokens_complete: cue("tokens_complete", "/audio/wheel/tokens-complete.mp3", "rewards", "reward", 0.7),

  steal_activate: cue("steal_activate", "/audio/combat/steal-activate.mp3", "combat", "combat", 0.85),
  ...
  guardian_block: cue("guardian_block", "/audio/combat/guardian-block.mp3", "combat", "combat", 0.85),
  steal_under_attack: cue("steal_under_attack", "/audio/combat/under-attack-steal.mp3", "combat", "combat", 0.9),
  ...
  top_squad: cue("top_squad", "/audio/reward/top-squad.mp3", "rewards", "reward", 0.9),
  phase_end: cue("phase_end", "/audio/ambient/phase-end.mp3", "transitions", "environment", 0.95),
