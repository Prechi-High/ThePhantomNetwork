...
export default function EditSessionPage() {
  ...
  useEffect(() => {
    ...
    void adminNetwork.getSession(sessionId).then((result) => {
  ...
  const handleSave = async () => {
    ...
    const result = await adminNetwork.patchSession(sessionId, {
  ...
  const handleCancel = async () => {
    ...
    await adminNetwork.deleteSession(sessionId);
