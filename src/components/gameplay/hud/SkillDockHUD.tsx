...
const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    bgTo: "#08011a",
    badge: (
      <div style={{ position: "absolute", top: "2px", right: "2px", background: "#7c3aed", borderRadius: "3px", padding: "1px 3px", fontSize: "7px", fontWeight: 900, color: "white", lineHeight: 1, boxShadow: "0 0 5px rgba(124,58,237,0.8)" }}>
        x2
      </div>
    ),
    labelColor: "#c084fc",
  ...
  },
  {
    ...
    bgTo: "#020f08",
    badge: (
      <div style={{ position: "absolute", top: "-3px", right: "-3px", background: "#22c55e", borderRadius: "50%", width: "14px", height: "14px", fontSize: "7px", fontWeight: 900, color: "#000", lineHeight: 1, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 0 5px rgba(34,197,94,0.8)" }}>
        x2
      </div>
    ),
    labelColor: "#22c55e",
